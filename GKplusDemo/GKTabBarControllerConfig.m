...
@interface GKTabBarControllerConfig ()

@property (nonatomic, readwrite, strong) CYLTabBarController *tabBarController;

@end

@implementation GKTabBarControllerConfig
...
- (NSArray *)viewControllers {
    GKHomeViewController *firstViewController = [[GKHomeViewController alloc] init];
    UIViewController *firstNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:firstViewController];
    
    GKSameViewController *secondViewController = [[GKSameViewController alloc] init];
    UIViewController *secondNavigationController = [[CYLBaseNavigationController alloc]
                                                    initWithRootViewController:secondViewController];
    
    GKMessageTableViewController *thirdViewController = [[GKMessageTableViewController alloc] init];
    UIViewController *thirdNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:thirdViewController];
    
    GKMineViewController *fourthViewController = [[GKMineViewController alloc] init];
