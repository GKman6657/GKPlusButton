...
- (YBPasterScrollView *)pasterScrollView
{
    if (!_pasterScrollView) {
        ...
        _pasterScrollView.frame = CGRectMake(0, FULL_SCREEN_H - pasterScrollView_H - bottomButtonH-66 , FULL_SCREEN_W, pasterScrollView_H);
...
- (YBFilterScrollView *)filterScrollView
{
    if (!_filterScrollView) {
        _filterScrollView = [[YBFilterScrollView alloc]initWithFrame:CGRectMake(0, FULL_SCREEN_H - pasterScrollView_H - bottomButtonH- 66, FULL_SCREEN_W, pasterScrollView_H)];
...
- (void)setupUI
{
    ...
    UIImageView *pasterImageView = [[UIImageView alloc]initWithFrame:CGRectMake(20, 10, FULL_SCREEN_W - 40, FULL_SCREEN_W - 40)];
    ...
    UIView *bottomBackView = [[UIView alloc]initWithFrame:CGRectMake(0, FULL_SCREEN_H - bottomButtonH - 66, FULL_SCREEN_W, bottomButtonH)];
